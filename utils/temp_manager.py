...
class TempManager:
    ...
    def get_temp_file(
        self, category: str = "general", suffix: str = "", prefix: str = "tmp_"
    ) -> Path:
        """
    ...
    @contextmanager
    def temp_directory(
        self, category: str = "general", prefix: str = "tmp_", auto_cleanup: bool = True
    ):
        """
        ...
        try:
            ...
            if auto_cleanup and temp_subdir.exists():
                try:
                    ...
                    logger.warning(
                        f"Failed to cleanup temp directory {temp_subdir}: {e}"
                    )
